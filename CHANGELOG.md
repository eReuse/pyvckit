...
- verify_dates ([#8](https://farga.pangea.org/ereuse/pyvckit/pulls/8))
- feature_ssl_false ([#6](https://farga.pangea.org/ereuse/pyvckit/pulls/6))
- dpp v3 ([#3](https://farga.pangea.org/ereuse/pyvckit/pulls/3))
- remove verification revoke credentials ([#4](https://farga.pangea.org/ereuse/pyvckit/pulls/4))
- v0.0.11 ([#2](https://farga.pangea.org/ereuse/pyvckit/pulls/2))
